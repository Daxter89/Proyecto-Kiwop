...
<div class="py-4 d-flex col-lg-9 gap-5 w-100">
    ...
    <div class="col-lg-8 ">
        ...
        <div class="card">
            <div class="card-header"><?php echo e(__('Nuevo Empleado')); ?></div>

            <div class="card-body">
                <form method="POST" action="<?php echo e(route('add.employee')); ?>">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row mb-3">
                        <label for="password-confirm" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Select Role')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Projecto horario\Sistema-Control-de-Empleados-y-Jornadas-main\resources\views/auth/register.blade.php ENDPATH**/ ?>